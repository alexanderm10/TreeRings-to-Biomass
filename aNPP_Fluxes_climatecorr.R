...
niwot.nep.m <- read.table("monthly_nep_niwot.txt", header=T)

#The Morgan Monroe flux record spans 1999-2005
mmf.nep.m <- read.table("monthly_nep_morgan.txt", header=T)
...
for(i in 1:110){
  ...
  setwd("/Users/mrossalexander/desktop/CRUNCEP_monthly/tair")
  ...
  setwd("/Users/mrossalexander/desktop/CRUNCEP_monthly/rain")
  ...
  setwd("/Users/mrossalexander/desktop/CRUNCEP_monthly/swdown_total")
  ...
  setwd("/Users/mrossalexander/desktop/CRUNCEP_monthly/qair")
...
#plotting graphs for climate response
